...
const FIGURES = {
  en: {
    "## §1 Text & language dimension": [
      ["§1 Post length · first-person rate · TTR distributions", "fig_linguistic.png"],
      ["§1 Vocabulary diversity (MTLD) · sentiment (VADER) distributions", "fig_lexical.png"],
    ],
    "## §2 Network & conversation-structure dimension": [
      ["§2 Comment-depth distribution — Reddit vs Moltbook", "fig_reply_depth.png"],
      ["§2 Reply-tree structure — flat star vs deep nesting", "fig_reply_tree.png"],
    ],
    "## §3 Time & behavior dimension (circadian)": [
      ["§3 24-hour posting rhythm (circadian)", "fig_circadian.png"],
    ],
    "## §4 Community & author-activity dimension": [
      ["§4 Per-author activity distribution", "fig_author_activity.png"],
    ],
    "## §5 Agent provenance (Moltbook-specific) — which LLM drives them": [
      ["§5 Agent driving-model provenance", "fig_provenance.png"],
    ],
    "## §6 Summary statistics — table & distribution tests": [
      ["§6 5-axis normalized comparison (radar)", "fig_radar.png"],
    ],
  },
  ko: {
    "## §1 텍스트·언어 차원": [
      ["§1 게시물 길이 · 1인칭 비율 · 어휘 다양도(TTR) 분포", "fig_linguistic.png"],
      ["§1 어휘 다양도(MTLD) · 감정(VADER) 분포", "fig_lexical.png"],
    ],
    "## §2 네트워크·대화 구조 차원": [
      ["§2 댓글 깊이 분포 — Reddit vs Moltbook", "fig_reply_depth.png"],
      ["§2 reply tree 구조 — 평평한 star vs 깊은 중첩", "fig_reply_tree.png"],
    ],
    "## §3 시간·행동 차원 (circadian)": [
      ["§3 24시간 게시 리듬 (circadian)", "fig_circadian.png"],
    ],
    "## §4 커뮤니티·작성자 활동 차원": [
      ["§4 작성자당 활동량 분포", "fig_author_activity.png"],
    ],
    "## §5 Agent provenance (Moltbook 특화) — 어떤 LLM으로 구동되나": [
      ["§5 에이전트 구동 모델 provenance", "fig_provenance.png"],
    ],
    "## §6 종합 통계 — 요약표 & 분포 검정": [
      ["§6 5축 정규화 비교 (radar)", "fig_radar.png"],
    ],
  },
};
